...
<body>
  <div class="container-fluid" align='center'>
    ...
    <div class="row well" style=" margin-top:10px; margin-bottom: 10px; width: 790px; height: 1135px;">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Conseguir Datos</button>
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="form-group">
              <textarea class="form-control table" name="nueva_gestion" rows="6" id="nueva_gestion" style="resize:none;" required></textarea>
            </div>
            </div>
            <div class="col-sm-5">
              <div class="row" align='left'>
                <div class="col-sm-11">
                  ...
                  <select  name="tipo_estado" id="tipo_estado" class="form-control InputStyle" required="required">
                    <option value="">Elija...</option>
                    <?php
                      foreach($entrada_estados as $estado){
                        if ($estado['TGPV_DSC'] != 'CERRADO' || $estado['TGPV_DSC'] != 'ASIGNADOS SIN GESTION' || $estado['TGPV_DSC'] != '--' || $estado['TGPV_DSC'] != 'SIN CONTACTO') {
                        ?>
